...
-- CASCADE because other test suites (e.g. balance) share this same in-memory DB within a test run
-- and may have already created tables (like trading.accounts) with a foreign key into iam.clients.
