...
@DisplayName("OrderHistoryController Tests")
class OrderHistoryControllerTest {
    ...
    @Test
    @DisplayName("GET /api/order/orders/history - 200 with paginated history items for authenticated client")
    ...
    @Test
    @DisplayName("GET /api/order/orders/history - 400 when invalid page param")
    ...
    @Test
    @WithAnonymousUser
    @DisplayName("GET /api/order/orders/history - 401 when unauthenticated")
